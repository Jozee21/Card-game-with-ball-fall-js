...
function resetBall() {
    ...
    ball.vx = getdirection(-4, 4);
    ball.vy = getdirection(-6, 6);
    ball.stopped = false;
}
...
function updateBall() {
    ...
    // stop stacking speed to prevent faster bouncing as time goes by
    const maxSpeed = 10;
